...
public class FetchLearnersModelMapper implements ResultSetMapper<LearnersModel> {


  @Override
  public LearnersModel map(int index, ResultSet r, StatementContext ctx) throws SQLException {
    LearnersModel model = new LearnersModel();
