...
class PersonalizedLearnersModel {
  ...
  private String rosterGlobalUserId;
  private String gradename;
  private List<String> gutGradeCodes;
  ...
  public String getRosterGlobalUserId() {
    return rosterGlobalUserId;
  }
  public void setRosterGlobalUserId(String rosterGlobalUserId) {
    this.rosterGlobalUserId = rosterGlobalUserId;
  }
  ...
  public List<String> getGutGradeCodes() {
    return gutGradeCodes;
  }
  public void setGutGradeCodes(List<String> gutGradeCodes) {
    this.gutGradeCodes = gutGradeCodes;
  }
